...
PBS_NODES="node02"
PREFIX="MF_overhead_hwpower_mf_mf_plugin_meminfo-1000msXXX_"
PREFIX+=$RANDOM
MV_COMM_START=5
MV_COMM_END=5
...
#  do
   ...
   do
     ...
     CONFIG_FILE=/nas_home/hpcdhopp/cel_job/mv/overhead/configurations/mf_config-mf_plugin_meminfo-1000ms.ini
