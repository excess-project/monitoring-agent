...
%% ~/HLRS/results/producerconsumer_2015-08-12_11.43/au8hsynu7zjpcdlgoa3w.json

basename = '../../../../HLRS/results/producerconsumer_2015-08-12_11.43/producerconsumer_result_2015-08-12_11.43-';
...
title([ 'CPU PKG/Socket power consumption - comparison of data sources. (' basename ')' ]);
xlabel("Time instant (sec since the epoch) (NOTE: daq shifted +4 sec!)");
ylim([0, 90]);
ylabel("Power (W)");
